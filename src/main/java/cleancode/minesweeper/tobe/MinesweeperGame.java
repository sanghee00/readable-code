...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                String userActionInput = getUserActionInpuFromtUser();
    ...
    private static boolean isLandMineCell(
    ...
    private static String getUserActionInpuFromtUser() {
    ...
    private static int countNearbyLandMines(
        int row,
        int col
    ) {
        int count = 0;
